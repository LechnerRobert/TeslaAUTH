...
//  Imported SHDocVw on 05.06.2019 16:00:05 from C:\Windows\System32\ieframe.dll
...
//  Warning: 'GUID' not automatable in IShellUIHelper9disp.QueryInterface
//  Warning: 'Ppointer' not automatable in IShellUIHelper9disp.QueryInterface
//  Warning: 'Ppointer' not automatable in IShellUIHelper9disp.GetTypeInfo
//  Warning: 'GUID' not automatable in IShellUIHelper9disp.GetIDsOfNames
//  Warning: 'PShortInt' not automatable in IShellUIHelper9disp.GetIDsOfNames
//  Warning: 'GUID' not automatable in IShellUIHelper9disp.Invoke
//  Warning: 'DISPPARAMS' not automatable in IShellUIHelper9disp.Invoke
//  Warning: 'EXCEPINFO' not automatable in IShellUIHelper9disp.Invoke
//  Warning: renamed parameter 'Type' in IShellUIHelper9.AddDesktopComponent to 'Type_'
//  Warning: renamed parameter 'Type' in IShellUIHelper9.AddToFavoritesBar to 'Type_'
...
Const
  ...
  IID_IShellUIHelper9 : TGUID = '{6CDF73B0-7F2F-451F-BC0F-63E0F3284E54}';
...
Type
 ...
 IShellUIHelper9Disp = dispinterface;
...
// IShellUIHelper9 : Shell UI Helper Control Interface 9

 IShellUIHelper9 = interface(IShellUIHelper8)
   ['{6CDF73B0-7F2F-451F-BC0F-63E0F3284E54}']
    // GetOSSku :  
   function GetOSSku:LongWord;safecall;
  end;
...
// IShellUIHelper9 : Shell UI Helper Control Interface 9
 ...
 IShellUIHelper9Disp = dispinterface
   ...
   procedure LaunchInHVSI(bstrUrl:WideString);dispid 99;
    // GetOSSku :  
   function GetOSSku:LongWord;dispid 103;
  end;
...
//CoClasses
  ...
  Public
    Class Function Create: IShellUIHelper9;
    Class Function CreateRemote(const MachineName: string): IShellUIHelper9;
  end;
...
Class Function CoShellUIHelper.Create: IShellUIHelper9;
begin
  Result := CreateComObject(CLASS_ShellUIHelper) as IShellUIHelper9;
end;

Class Function CoShellUIHelper.CreateRemote(const MachineName: string): IShellUIHelper9;
begin
  Result := CreateRemoteComObject(MachineName,CLASS_ShellUIHelper) as IShellUIHelper9;
end;
